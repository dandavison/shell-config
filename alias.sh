...
alias gpob='git pull origin $(git symbolic-ref --short HEAD)'
alias gprob='git pull --rebase origin $(git symbolic-ref --short HEAD)'
alias gr='git reset'
alias gr1='git reset HEAD~1'
alias gr2='git reset HEAD~2'
alias grh='git reset --hard'
alias grhh='git reset --hard HEAD'
alias grhob='git reset --hard origin/$(git symbolic-ref --short HEAD)'
