...
alias dnew='ln -fs ~/src/delta/target/release/delta ~/bin/delta; delta --version'
alias dold='ln -fs /usr/local/bin/delta ~/bin/delta; delta --version'
alias dps='docker ps'
...
alias rg='rg --color=always -M 1000'
alias rn='rename'
