...
alias es='emacs-grep'
alias exa="exa --group-directories-first --ignore-glob '*.pyc|__pycache__|Icon*'"
alias f='fzf'
...
alias lt='ls -lh -s new'
alias lth='ls -lh -s new | head'
...
alias ss='sourcegraph-search'
alias ssl='sourcegraph-search-files'
alias ssh='ssh -A'
