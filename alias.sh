...
alias ddbg='ln -fs ~/devenv/delta/target/debug/delta ~/bin/delta; delta --version'
alias ddev='ln -fs ~/devenv/delta/target/release/delta ~/bin/delta; delta --version'
...
alias gstsp='git stash show --relative -p'
