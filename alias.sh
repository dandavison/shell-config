...
alias k=kill-fzf
alias l='less'
alias latex='latex -shell-escape -interaction nonstopmode'
alias le='lein'
alias ler='lein repl'
alias less='less -SX'
alias l1='ls -1'
...
alias m='cd $(git rev-parse --show-toplevel) && make build && make test'
...
alias make-test='cd $(git rev-parse --show-toplevel) && make test'
