...
alias c='fzf-git-checkout-branch'
...
alias gcz='fzf-git-checkout-branch'
alias gd='git diff'
alias gdc='gd --cached'
...
alias glbz='fzf-git-log'
alias glz='fzf-git-checkout-commit'
alias gm='git merge'
...
alias pytest-quiet='pytest --no-header --tb=short --disable-warnings --log-level=ERROR --log-cli-level=ERROR'
